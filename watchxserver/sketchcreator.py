...
# Default sketch name
default_sketch_name = 'watchxsketch'


def create_sketch(sketch_dir, sketch_name=default_sketch_name, sketch_code=default_sketch_code):
    ...
    if not isinstance(sketch_code, six.string_types) or not isinstance(sketch_name, six.string_types):
