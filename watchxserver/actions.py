...
def create_sketch_from_string(sketch_code):
    ...
    return sketchcreator.create_sketch(sketch_dir=settings.sketch_dir, sketch_name=settings.sketch_name, sketch_code=sketch_code)
...
def load_arduino_cli(sketch_path):
    ...
    elif not settings.get_arduino_board_flag() and (settings.load_ide_option == 'upload' or settings.load_ide_option == 'verify'):
        success = False
        exit_code = 56
