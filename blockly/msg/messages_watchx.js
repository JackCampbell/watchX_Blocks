...
Blockly.Msg.ARD_ANALOGREAD_TIP = 'Return a value between 0 and 1024';
...
Blockly.Msg.ARD_BUILTIN_LED_TIP = 'Light on or off for the built-in LED of the watchX';
...
Blockly.Msg.ARD_SERVO_WRITE_TIP = 'Set a SERVO to a specified angle';
...
Blockly.Msg.WX_DRAW_USB_ICON = 'draw USB icon';
Blockly.Msg.WX_DRAW_USB_ICON_TIP = 'Draw the USB icon at the given X - Y position. X lateral position within range 0 - 127, Y vertical position within range 0 - 63.';
Blockly.Msg.WX_DRAW_CHARGE_ICON = 'draw charge icon';
Blockly.Msg.WX_DRAW_CHARGE_ICON_TIP = 'Draw the charge icon at the given X - Y position. X lateral position within range 0 - 127, Y vertical position within range 0 - 63.';
...
Blockly.Msg.WX_CURRENT_TIME = 'current time & date';
...
Blockly.Msg.WX_GET_BATTERY_VOLTAGE = 'get battery level (V)';
Blockly.Msg.WX_GET_BATTERY_VOLTAGE_TIP = 'Measures the battery voltage in Volts.';
Blockly.Msg.WX_GET_BATTERY_PERCENT = 'get battery level (%)';
...
Blockly.Msg.WX_BLUETOOTH_TRANSCEIVER = 'transceiver';
Blockly.Msg.WX_BLUETOOTH_KEYBOARD = 'BTKeyboard';
Blockly.Msg.WX_BLUETOOTH_HID_CONTROL = 'HIDControl';
Blockly.Msg.WX_BUZZER_HALF = 'half';
Blockly.Msg.WX_BUZZER_QUARTER = 'quarter';
Blockly.Msg.WX_BUZZER_EIGHTH = 'eighth';
Blockly.Msg.WX_BUZZER_WHOLE = 'whole';
Blockly.Msg.WX_BUZZER_DOUBLE = 'double';
Blockly.Msg.WX_BUZZER_ZERO = 'zero';
Blockly.Msg.WX_ALIGN_LEFT = 'left';
Blockly.Msg.WX_ALIGN_MIDDLE = 'middle';
Blockly.Msg.WX_ALIGN_RIGHT = 'right';
Blockly.Msg.WX_BUTTON_INPUT = 'read button once';
Blockly.Msg.WX_BUTTON_INPUT_TIP = 'Gets the status of the button, single-shot pressed-on time duration. Delivers input value (state) after it has been stable.';
Blockly.Msg.WX_GPAD_INPUT = 'read G-Pad button once';
