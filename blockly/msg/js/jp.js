...
Blockly.Msg.AUTH = "作品を保存・共有するためには、このアプリを認証してください。";
Blockly.Msg.CHANGE_VALUE_TITLE = "値を変える：";
Blockly.Msg.CHAT = "こちらのボックスにメッセージを入力して、共同編集者とチャットができます!";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END = "リスト内の指定された位置に項目を設定します。＃ 1 は、最後の項目です。";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START = "リスト内の指定された位置に項目を設定します。＃ 1 は、最初の項目です。.";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_LAST = "リストの末尾に項目を追加します。";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_RANDOM = "リスト内にランダムなアイテムを設定します。";
...
Blockly.Msg.LOGIC_NULL_HELPURL = "https://ja.wikipedia.org/wiki/Nullable型";
...
Blockly.Msg.LOGIC_TERNARY_HELPURL = "https://ja.wikipedia.org/wiki/条件演算子";
...
Blockly.Msg.MATH_IS_DIVISIBLE_BY = "で割り切れる";
...
Blockly.Msg.TEXT_APPEND_APPENDTEXT = "テキストを追加";
...
// watchxストリング
Blockly.Msg.ARD_ANALOGREAD = "アナログピンを読み取る #";
Blockly.Msg.ARD_ANALOGREAD_TIP = "0から1024までの値を返す";
Blockly.Msg.ARD_ANALOGWRITE = "アナログピンを設定 #";
Blockly.Msg.ARD_ANALOGWRITE_TIP = "0から255までのアナログ値を特定のPWMポートに書き込む。";
Blockly.Msg.ARD_BUILTIN_LED = "ビルトインLEDの設定";
Blockly.Msg.ARD_BUILTIN_LED_TIP = "WatchxのビルトインLEDの点灯/ 消灯";
Blockly.Msg.ARD_COMPONENT_WARN1 = "このブロックを使用するには、%2' 型の '%1' という名前の構成ブロックを追加する必要があります。";
Blockly.Msg.ARD_DEFINE = "定義";
Blockly.Msg.ARD_DIGITALREAD = "デジタルを読み取る #";
Blockly.Msg.ARD_DIGITALREAD_TIP = "デジタル値を読み取る：高又は低";
Blockly.Msg.ARD_DIGITALWRITE = "デジタルピンを設定 #";
Blockly.Msg.ARD_DIGITALWRITE_TIP = "デジタル値を特定のポートに高い又は低いで書き込む";
Blockly.Msg.ARD_FUN_RUN_LOOP = "watchX無限ループ:";
Blockly.Msg.ARD_FUN_RUN_SETUP = "watchXファーストラン:";
Blockly.Msg.ARD_FUN_RUN_TIP = "Arduinoのセットアップ()とループ()ファンクションを定義します。";
Blockly.Msg.ARD_HIGH = "高い";
Blockly.Msg.ARD_HIGHLOW_TIP = "ピン状態ロジックを高いまたは低いに設定します。";
Blockly.Msg.ARD_LOW = "低い";
Blockly.Msg.ARD_MAP = "マップ";
Blockly.Msg.ARD_MAP_TIP = "0から1024まで番号を別の番号にリマップする。";
Blockly.Msg.ARD_MAP_VAL = "値を[0-";
Blockly.Msg.ARD_NOTONE = "ピンのトーンをオフにする #";
Blockly.Msg.ARD_NOTONE_PIN = "トーンピンなし #";
Blockly.Msg.ARD_NOTONE_PIN_TIP = "ピンのトーンの生成を停止";
Blockly.Msg.ARD_NOTONE_TIP = "選択されたピンのトーンをオフにする";
Blockly.Msg.ARD_PIN_WARN1 = "ピン %1 は、ピン %3 として %2 に必要です。すでに %4 として使用されている。";
Blockly.Msg.ARD_PULSETIMEOUT_TIP = "選択されたピンのパルスの持続時間を測定し、それがタイムアウト以内であれば、マイクロ秒単位で表示する。.";
Blockly.Msg.ARD_PULSE_READ = "ピン#%2で%1パルスを測定";
Blockly.Msg.ARD_PULSE_READ_TIMEOUT = "ピン#%2で%1パルスを測定（%3μs後にタイムアウト）";
Blockly.Msg.ARD_PULSE_TIP = "選択された端子のパルスの持続時間を測定する。";
Blockly.Msg.ARD_SERIAL_BPS = "BPS";
Blockly.Msg.ARD_SERIAL_PRINT = "プリント";
Blockly.Msg.ARD_SERIAL_PRINT_NEWLINE = "新しいラインを追加する";
Blockly.Msg.ARD_SERIAL_PRINT_TIP = "コンソール/シリアルポートにデータを人間が読めるASCIIテキストとして印刷する。";
Blockly.Msg.ARD_SERIAL_PRINT_WARN = "このブロックを使用するには、%1 のセットアップ・ブロックをワークスペースに追加する必要がある。";
Blockly.Msg.ARD_SERIAL_SETUP = "セットアップ";
Blockly.Msg.ARD_SERIAL_SETUP_TIP = "特定のシリアルペリフェラルの速度を選択する。";
Blockly.Msg.ARD_SERIAL_SPEED = ": スピードアップ";
Blockly.Msg.ARD_SERVO_READ = "ピン＃からサーボを読み取る";
Blockly.Msg.ARD_SERVO_READ_TIP = "サーボの角度を読み取る";
Blockly.Msg.ARD_SERVO_WRITE = "ピンからサーボを設定 #";
Blockly.Msg.ARD_SERVO_WRITE_DEG_180 = "度(0~180)";
Blockly.Msg.ARD_SERVO_WRITE_TIP = "サーボの角度を指定する";
Blockly.Msg.ARD_SERVO_WRITE_TO = "に";
Blockly.Msg.ARD_SETTONE = "ピンのトーンを設定する #";
Blockly.Msg.ARD_SPI_SETUP = "セットアップ";
Blockly.Msg.ARD_SPI_SETUP_CONF = "コンフィギュレーション:";
Blockly.Msg.ARD_SPI_SETUP_DIVIDE = "時計デバイド";
Blockly.Msg.ARD_SPI_SETUP_LSBFIRST = "最下位ビット";
Blockly.Msg.ARD_SPI_SETUP_MODE = "SPIモード (アイドル ・エッジ)";
Blockly.Msg.ARD_SPI_SETUP_MODE0 = "0 (低い・下降)";
Blockly.Msg.ARD_SPI_SETUP_MODE1 = "1 (低い・上昇)";
Blockly.Msg.ARD_SPI_SETUP_MODE2 = "2 (高い・下降)";
Blockly.Msg.ARD_SPI_SETUP_MODE3 = "3 (高い・上昇)";
Blockly.Msg.ARD_SPI_SETUP_MSBFIRST = "最上位ビット";
Blockly.Msg.ARD_SPI_SETUP_SHIFT = "データ・シフト";
Blockly.Msg.ARD_SPI_SETUP_TIP = "SPIペリフェラルを設定する";
Blockly.Msg.ARD_SPI_TRANSRETURN_TIP = "指定されたスレーブデバイスにSPIメッセージを送信し、データを取得します。";
Blockly.Msg.ARD_SPI_TRANS_NONE = "なし";
Blockly.Msg.ARD_SPI_TRANS_SLAVE = "スレーブピンへ #";
Blockly.Msg.ARD_SPI_TRANS_TIP = "指定されたスレーブデバイスにSPIメッセージを送信します。";
Blockly.Msg.ARD_SPI_TRANS_VAL = "トランスファー";
Blockly.Msg.ARD_SPI_TRANS_WARN1 = "ブロックを使用するには、%1 のセットアップ・ブロックをワークスペースに追加する必要があります！";
Blockly.Msg.ARD_SPI_TRANS_WARN2 = "古いピン値 %1 は使用できなくなりました。";
Blockly.Msg.ARD_STEPPER_COMPONENT = "ステッパー";
Blockly.Msg.ARD_STEPPER_DEFAULT_NAME = "マイステッパー";
Blockly.Msg.ARD_STEPPER_FOUR_PINS = "4";
Blockly.Msg.ARD_STEPPER_MOTOR = "ステッパーモーター";
Blockly.Msg.ARD_STEPPER_NUMBER_OF_PINS = "ピン数";
Blockly.Msg.ARD_STEPPER_PIN1 = "ピン1 #";
Blockly.Msg.ARD_STEPPER_PIN2 = "ピン2 #";
Blockly.Msg.ARD_STEPPER_PIN3 = "ピン3 #";
Blockly.Msg.ARD_STEPPER_PIN4 = "ピン4 #";
Blockly.Msg.ARD_STEPPER_REVOLVS = "回転ステップ数";
Blockly.Msg.ARD_STEPPER_SETUP = "ステッパーモーターのセットアップ";
Blockly.Msg.ARD_STEPPER_SETUP_TIP = "ステッパーモーターのピン配列およびその他の設定を構成します。";
Blockly.Msg.ARD_STEPPER_SPEED = "速度（RPM）をに設定する";
Blockly.Msg.ARD_STEPPER_STEP = "ステッパーを動かす";
Blockly.Msg.ARD_STEPPER_STEPS = "ステップ";
Blockly.Msg.ARD_STEPPER_STEP_TIP = "ステッパーモーターを特定のステップ数だけ回転させます。";
Blockly.Msg.ARD_STEPPER_TWO_PINS = "2";
Blockly.Msg.ARD_TIME_DELAY = "待ち";
Blockly.Msg.ARD_TIME_DELAY_MICROS = "マイクロ秒";
Blockly.Msg.ARD_TIME_DELAY_MICRO_TIP = "特定の時間をマイクロ秒単位で待つ。";
Blockly.Msg.ARD_TIME_DELAY_TIP = "特定の時間をミリ秒秒単位で待つ。";
Blockly.Msg.ARD_TIME_INF = "待ち続け(プログラム終了)";
Blockly.Msg.ARD_TIME_INF_TIP = "無期限に待機、プログラムを停止します。";
Blockly.Msg.ARD_TIME_MICROS = "現在の経過時間(マイクロ秒)";
Blockly.Msg.ARD_TIME_MICROS_TIP = "Arduinoボードが現在のプログラムの実行を開始してからのマイクロ秒数を返します。正の長整数で格納する必要があります。";
Blockly.Msg.ARD_TIME_MILLIS = "現在の経過時間(ミリ秒)";
Blockly.Msg.ARD_TIME_MILLIS_TIP = "Arduinoボードが現在のプログラムの実行を開始してからのミリ秒数を返します。正の長整数で格納する必要があります。";
Blockly.Msg.ARD_TIME_MS = "現在の経過時間(ミリ秒)";
Blockly.Msg.ARD_TONEFREQ = "周波数で";
Blockly.Msg.ARD_TONE_FREQ = "周波数";
Blockly.Msg.ARD_TONE_PIN = "トーンピン #";
Blockly.Msg.ARD_TONE_PIN_TIP = "オーディオ・トーンピンを発生させる";
Blockly.Msg.ARD_TONE_TIP = "ピントーンを31～65535の範囲で指定した周波数に設定する";
Blockly.Msg.ARD_TONE_WARNING = "周波数は31～65535の範囲であること";
Blockly.Msg.ARD_TYPE_ARRAY = "アレイ";
Blockly.Msg.ARD_TYPE_BOOL = "ブーリアン";
Blockly.Msg.ARD_TYPE_CHAR = "キャラクタ";
Blockly.Msg.ARD_TYPE_CHILDBLOCKMISSING = "ChildBlockMissing";
Blockly.Msg.ARD_TYPE_DECIMAL = "デシマル";
Blockly.Msg.ARD_TYPE_LONG = "大数";
Blockly.Msg.ARD_TYPE_NULL = "ヌル";
Blockly.Msg.ARD_TYPE_NUMBER = "番号";
Blockly.Msg.ARD_TYPE_SHORT = "短い数";
Blockly.Msg.ARD_TYPE_TEXT = "テキスト";
Blockly.Msg.ARD_TYPE_UNDEF = "未定義";
Blockly.Msg.ARD_VAR_AS = "と";
Blockly.Msg.ARD_VAR_AS_TIP = "値を特定の型に設定する";
Blockly.Msg.ARD_WRITE_TO = "へ";
Blockly.Msg.NEW_INSTANCE = "新規インスタンス";
Blockly.Msg.NEW_INSTANCE_TITLE = "新規インスタンス名：";
Blockly.Msg.RENAME_INSTANCE = "インスタンスの名前変更";
Blockly.Msg.RENAME_INSTANCE_TITLE = "すべての '％1'インスタンスの名前変更";
Blockly.Msg.WX_ALIGN_LEFT = "左";
Blockly.Msg.WX_ALIGN_MIDDLE = "中";
Blockly.Msg.WX_ALIGN_RIGHT = "右";
Blockly.Msg.WX_ALTITUDE = "高度";
Blockly.Msg.WX_BEAT = "ビート";
Blockly.Msg.WX_BLE_KEY_PRESS = "ブルートゥース キーを押す";
Blockly.Msg.WX_BLE_KEY_PRESS_TIP = "ブルートゥース キーとして動作し、キーボードのキーストロークを送信します。";
Blockly.Msg.WX_BLE_MEDIA_CONTROL = "ブルートゥースメディアコントロール";
Blockly.Msg.WX_BLE_MEDIA_CONTROL_TIP = "コンピューターまたは携帯電話に接続したときにメディア制御を許可します。 ";
Blockly.Msg.WX_BLE_MOUSE_CONTROL = "ワイヤレスマウスボタン";
Blockly.Msg.WX_BLE_MOUSE_CONTROL_TIP = "ワイヤレスマウスクリック送信を許可する";
Blockly.Msg.WX_BLUETOOTH = "ブルートゥース";
Blockly.Msg.WX_BLUETOOTH_HID_CONTROL = "HIDコントロール";
Blockly.Msg.WX_BLUETOOTH_INIT_TIP = "ブルートゥースモジュールをさまざまなモードに設定します。IDを使用すると、、ユニークなブルートゥースデバイス名を付けることができます。";
Blockly.Msg.WX_BLUETOOTH_KEYBOARD = "BTキーボード";
Blockly.Msg.WX_BLUETOOTH_RECV = "ブルートゥースでテキストを受信する";
Blockly.Msg.WX_BLUETOOTH_RECV_TIP = "ブルートゥース機器とデータを送受信できます。";
Blockly.Msg.WX_BLUETOOTH_SEND = "ブルートゥース 送信";
Blockly.Msg.WX_BLUETOOTH_SEND_TIP = "ブルートゥース でデータを送信する";
Blockly.Msg.WX_BLUETOOTH_TRANSCEIVER = "送受信機";
Blockly.Msg.WX_BPM = "BPMを設定する";
Blockly.Msg.WX_BPM_TIP = "";
Blockly.Msg.WX_BUTTON_INPUT = "読込ボタンを押す";
Blockly.Msg.WX_BUTTON_INPUT_TIP = "ボタンの状態と押された時間の長さを一発で取得する。安定した後の入力値(状態)を伝える。";
Blockly.Msg.WX_BUZZER_DOUBLE = "ダブル";
Blockly.Msg.WX_BUZZER_EIGHTH = "第八";
Blockly.Msg.WX_BUZZER_HALF = "ハーフ";
Blockly.Msg.WX_BUZZER_QUARTER = "クォーター";
Blockly.Msg.WX_BUZZER_WHOLE = "全体";
Blockly.Msg.WX_BUZZER_ZERO = "ゼロ";
Blockly.Msg.WX_BZR_PLAY_NOTE = "プレイ・トーン・ノート";
Blockly.Msg.WX_BZR_PLAY_NOTE_TIP = "選択したノートは内蔵ブザーで鳴ります。  ビートはは、ノートの長さを設定します。";
Blockly.Msg.WX_BZR_STOP = "トーンなし";
Blockly.Msg.WX_BZR_STOP_TIP = "";
Blockly.Msg.WX_CHARGE_COMPLETE = "充電完了を検出する";
Blockly.Msg.WX_CHARGE_COMPLETE_TIP = "充電中のwatchXのバッテリーの充電状態をチェックします。バッテリーが完全に充電されていれば、trueを返します。";
Blockly.Msg.WX_CHECK_USB_CONNECTION = "USB接続を確認する";
Blockly.Msg.WX_CHECK_USB_CONNECTION_TIP = "watchXがUSBソースに接続されている場合、trueを返します。";
Blockly.Msg.WX_CURRENT_TIME = "現在の時刻＆日付";
Blockly.Msg.WX_CURRENT_TIME_TIP = "コンピューターの日付と時刻をwatchXの時間単位で設定します。 ";
Blockly.Msg.WX_DAY = "日";
Blockly.Msg.WX_DETECT_MOTION = "動体検知";
Blockly.Msg.WX_DETECT_MOTION_TIP = "MPU-6050には動体検知が内蔵されています。感度は閾値と継続時間の値で調整します。";
Blockly.Msg.WX_DRAW_BATTERY_LEVEL = "ドロー・バッテリー・レベル";
Blockly.Msg.WX_DRAW_BATTERY_LEVEL_TIP = "指定されたX-Y位置にバッテリーアイコンを描画します。パーセントはバッテリーの残量を示します。Xの横方向の位置は0〜127の範囲内、Yの縦方向の位置は0〜63の範囲内です。";
Blockly.Msg.WX_DRAW_CHARGE_ICON = "ドローイング充電アイコン";
Blockly.Msg.WX_DRAW_CHARGE_ICON_TIP = "指定されたX-Y位置に充電アイコンを描きます。Xの横方向の位置は0～127、Yの縦方向の位置は0～63の範囲で指定します。";
Blockly.Msg.WX_DRAW_LINE = "ドローイングライン";
Blockly.Msg.WX_DRAW_LINE_TIP = "ドローイングライン。 線の始点をX1、Y1とし、線の終点をX2、Y2とする。Xの水平方向の位置は0～127、Yの垂直方向の位置は0～63の範囲内であります。";
Blockly.Msg.WX_DRAW_PIXEL = "ドローイングピクセル";
Blockly.Msg.WX_DRAW_PIXEL_TIP = "指定されたX-Y位置に1つのピクセルをドローイングします。Xの横方向の位置は0～127、Yの縦方向の位置は0～63の範囲で指定できます。";
Blockly.Msg.WX_DRAW_USB_ICON = "ドローイングUSBアイコン";
Blockly.Msg.WX_DRAW_USB_ICON_TIP = "USBアイコンを指定されたX-Yの位置にドローイングします。Xの横方向の位置は0～127、Yの縦方向の位置は0～63の範囲で指定します。";
Blockly.Msg.WX_DURATION = "デュレーション";
Blockly.Msg.WX_FILTER = "フィルタ";
Blockly.Msg.WX_FREE_FALL_DETECTED = "自由落下検出する";
Blockly.Msg.WX_FREE_FALL_DETECTED_TIP = "内蔵されたMPU6050センサーで自由落下を検出します。しきい値と継続時間を用いて感度を調整します。";
Blockly.Msg.WX_GET = "取得";
Blockly.Msg.WX_GET_BATTERY_PERCENT = "バッテリー残量の取得(%)";
Blockly.Msg.WX_GET_BATTERY_PERCENT_TIP = "バッテリーの電圧を測定し、0～100の値を返します。";
Blockly.Msg.WX_GET_BATTERY_VOLTAGE = "バッテリー残量の取得 (V)";
Blockly.Msg.WX_GET_BATTERY_VOLTAGE_TIP = "バッテリーの電圧をボルトで測定します。";
Blockly.Msg.WX_GET_BMP = "取得";
Blockly.Msg.WX_GET_BMP_TIP = "内蔵されたBMP280センサーから、選択された高度、圧力、温度の値を取得します。高度はメートル単位、圧力はパスカル単位、温度は摂氏単位で表示されます。";
Blockly.Msg.WX_GET_MAG = "MAG3110取得";
Blockly.Msg.WX_GET_MAG_TIP = "内蔵されているMAG3110センサーから磁界データを取得します。磁界の単位はマイクロテスラ(uT)です。このセンサーは、watchX v1.3以降ではMLX90393センサーに置き換えられています。";
Blockly.Msg.WX_GET_MLX = "磁力計を取得";
Blockly.Msg.WX_GET_MLX_TIP = "内蔵されているMLX90393センサの磁界データを取得します。フィルタリング機能付きなので、より分かりやすくなっています。磁界の単位はマイクロテスラ(uT)です。";
Blockly.Msg.WX_GET_MPU_ACCEL = "IMUで加速度を取得";
Blockly.Msg.WX_GET_MPU_ACCEL_TIP = "内蔵されたMPU6050センサーの加速度データをメートル毎秒平方で取得します。";
Blockly.Msg.WX_GET_MPU_ANGLE = "IMUの角度取得";
Blockly.Msg.WX_GET_MPU_ANGLE_TIP = "内蔵されたMPU6050センサーから、地面とwatchXの間の角度を取得します。Xはピッチ角、Yはロール角です。";
Blockly.Msg.WX_GET_TIME_TIP = "watchXの時間単位から現在の日付・時間単位を取得します。";
Blockly.Msg.WX_GPAD_INPUT = "G-Padボタンを一回押す";
Blockly.Msg.WX_GPAD_INPUT_TIP = "ボタンの状態、単発で押された時間の長さを取得する。安定した後の入力値（状態）を伝える。";
Blockly.Msg.WX_HOUR = "時";
Blockly.Msg.WX_ID = "id";
Blockly.Msg.WX_INIT = "イニット";
Blockly.Msg.WX_INTERVALS = "インターバル";
Blockly.Msg.WX_LED_BRIGHTNESS = "LED輝度";
Blockly.Msg.WX_LED_BRIGHTNESS_TIP = "輝度調整で選択された光のON/OFF";
Blockly.Msg.WX_LED_LEVEL = " レベル ";
Blockly.Msg.WX_LEFT = "左";
Blockly.Msg.WX_LINE = "ライン";
Blockly.Msg.WX_MINUTE = "分";
Blockly.Msg.WX_MONTH = "月";
Blockly.Msg.WX_NEXT = "次";
Blockly.Msg.WX_OLED_BRIGHTNESS = "ディスプレイ輝度";
Blockly.Msg.WX_OLED_BRIGHTNESS_TIP = "ディスプレイの明るさを高い/低いで設定します。高いは視認性を高めるため、低いは低消費電力を実現するための設定です。";
Blockly.Msg.WX_OLED_CLEAR_ALL = "ディスプレイ・クリア";
Blockly.Msg.WX_OLED_CLEAR_ALL_TIP = "ディスプレイに表示されているデータをすべて消去します。";
Blockly.Msg.WX_OLED_POWER = "ディスプレイ・パワー";
Blockly.Msg.WX_OLED_POWER_TIP = "ディスプレイの表示をON/OFFします。高いで点灯、低いで消灯します。";
Blockly.Msg.WX_OLED_WRITE = "ディスプレイ・ライト";
Blockly.Msg.WX_OLED_WRITE_ALIGN = "アライン";
Blockly.Msg.WX_OLED_WRITE_LINE = "ライン";
Blockly.Msg.WX_OLED_WRITE_LINE_TIP = "watchX ディスプレイにデータを表示し、1～8 の範囲でラインを設定し、テキストを左寄せ、中央寄せ、右寄せにします。  ";
Blockly.Msg.WX_OLED_WRITE_POS_TIP = "watchX ディスプレイに表示されるデータは、Xの横方向の位置が0～127の範囲、Yの縦方向の位置が0～63の範囲です。";
Blockly.Msg.WX_PERCENT = "パーセント";
Blockly.Msg.WX_PLAY_FREQ = "プレイ頻度";
Blockly.Msg.WX_PLAY_FREQ_TIP = "内蔵のブザーのトーンを設定、周波数は31～65535の範囲内";
Blockly.Msg.WX_PLAY_PAUSE = "プレイ/ポーズ";
Blockly.Msg.WX_PRESSED = "プレス";
Blockly.Msg.WX_PRESSURE = "プレッシャー";
Blockly.Msg.WX_PREVIOUS = "前回";
Blockly.Msg.WX_PRINT_TIME = "ディスプレイタイム";
Blockly.Msg.WX_PRINT_TIME_LINE_TIP = "時、分、秒を大きなフォントで表示し、1～8の範囲でラインを設定します。";
Blockly.Msg.WX_PRINT_TIME_POS_TIP = "時、分、秒を指定されたX-Y位置に大きなフォントで表示します。Xの横方向の位置は0～127、Yの縦方向の位置は0～63の範囲で指定します。";
Blockly.Msg.WX_PX = "X";
Blockly.Msg.WX_PY = "Y";
Blockly.Msg.WX_READ_BUTTON = "読み込みボタン";
Blockly.Msg.WX_READ_BUTTON_TIP = "ボタンが押されているかどうかの状態を取得します。押されていればtrueを返します。";
Blockly.Msg.WX_READ_GPAD = "読み取り G-Pad ボタン";
Blockly.Msg.WX_READ_GPAD_TIP = "Game Padのボタンが押されているかどうかの状態を取得します。押されていればtrueを返します。";
Blockly.Msg.WX_RELEASE = "リリース";
Blockly.Msg.WX_RIGHT = "右";
Blockly.Msg.WX_SECOND = "秒";
Blockly.Msg.WX_SET_DATE = "日付を設定する";
Blockly.Msg.WX_SET_DATE_TIP = "指定された日付と時刻をwatchXの時間単位に設定します。";
Blockly.Msg.WX_SLEEP_AND_WAKE_BUTTON = "スリープボタン＆復帰ボタン";
Blockly.Msg.WX_SLEEP_AND_WAKE_BUTTON_TIP = "ブロックが実行されるとスリープ状態になり、述べられたボタンが押されると復帰します。";
Blockly.Msg.WX_SLEEP_AND_WAKE_TIMER = "スリープと復帰時間";
Blockly.Msg.WX_SLEEP_AND_WAKE_TIMER_TIP = "一定の間隔でスリープ又は復帰する";
Blockly.Msg.WX_TEMPERATURE = "サーミスタ";
Blockly.Msg.WX_THRESHOLD = "スレッショルド";
Blockly.Msg.WX_TO = "に";
Blockly.Msg.WX_TURN_LED = "LEDを回す";
Blockly.Msg.WX_TURN_LED_TIPS = "watchXの内蔵LEDの点灯・消灯を選択する";
Blockly.Msg.WX_VOLUME_DOWN = "ボリューム(-)";
Blockly.Msg.WX_VOLUME_UP = "ボリューム(+)";
Blockly.Msg.WX_YEAR = "年";
