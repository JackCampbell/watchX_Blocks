 ...
 */
Blockly.Arduino.Boards.duplicateBoardProfile = function(originalBoard, name_, description, compilerFlag) {
  return {
    name: name_,
...
Blockly.Arduino.Boards.profiles.watchX = {
  ...
  pwmPins: [['3', '3'], ['5', '5'], ['6', '6'], ['9', '9'], ['10', '10'], ['11', '11'], ['13', '13']],
...
Blockly.Arduino.Boards.reference = new Object();

/** Arduino Uno board profile. */
Blockly.Arduino.Boards.reference.uno = {
  name: 'Arduino Uno',
...
Blockly.Arduino.Boards.reference.nano_328 = {
  ...
  pwmPins: Blockly.Arduino.Boards.reference.uno.pwmPins,
  serial: Blockly.Arduino.Boards.reference.uno.serial,
  serialPins: Blockly.Arduino.Boards.reference.uno.serialPins,
  serialSpeed: Blockly.Arduino.Boards.reference.uno.serialSpeed,
  spi: Blockly.Arduino.Boards.reference.uno.spi,
  spiPins: Blockly.Arduino.Boards.reference.uno.spiPins,
  spiClockDivide: Blockly.Arduino.Boards.reference.uno.spiClockDivide,
  i2c: Blockly.Arduino.Boards.reference.uno.i2c,
  i2cPins: Blockly.Arduino.Boards.reference.uno.i2cPins,
  i2cSpeed: Blockly.Arduino.Boards.reference.uno.i2cSpeed,
  builtinLed: Blockly.Arduino.Boards.reference.uno.builtinLed,
  interrupt: Blockly.Arduino.Boards.reference.uno.interrupt
};
Blockly.Arduino.Boards.reference.nano_168 = Blockly.Arduino.Boards.duplicateBoardProfile(
        Blockly.Arduino.Boards.reference.nano_328,
        'Arduino Nano 168',
...
Blockly.Arduino.Boards.reference.duemilanove_168p = {
  ...
  analogPins: Blockly.Arduino.Boards.reference.uno.analogPins,
  digitalPins: Blockly.Arduino.Boards.reference.uno.digitalPins,
  pwmPins: Blockly.Arduino.Boards.reference.uno.pwmPins,
  serial: Blockly.Arduino.Boards.reference.uno.serial,
  serialPins: Blockly.Arduino.Boards.reference.uno.serialPins,
  serialSpeed: Blockly.Arduino.Boards.reference.uno.serialSpeed,
...
Blockly.Arduino.Boards.reference.duemilanove_328p = Blockly.Arduino.Boards.duplicateBoardProfile(
        Blockly.Arduino.Boards.reference.duemilanove_168p,
...
Blockly.Arduino.Boards.reference.mega = {
  name: 'Arduino Mega',
...
Blockly.Arduino.Boards.reference.leonardo = {
  name: 'Arduino watchX',
  ...
  digitalPins: Blockly.Arduino.Boards.generateDigitalIo(0, 13).concat(
                   Blockly.Arduino.Boards.generateAnalogIo(0, 5)),
  pwmPins: Blockly.Arduino.Boards.reference.uno.pwmPins.concat([['13', '13']]),
  serial: Blockly.Arduino.Boards.reference.uno.serial,
  serialPins: Blockly.Arduino.Boards.reference.uno.serialPins,
  serialSpeed: Blockly.Arduino.Boards.reference.uno.serialSpeed,
  spi: [['SPI', 'SPI']],
...
Blockly.Arduino.Boards.reference.yun = Blockly.Arduino.Boards.duplicateBoardProfile(
        Blockly.Arduino.Boards.reference.leonardo,
        'Arduino Yun',
        'Arduino Yun compatible board');

/** Atmel Xplained mini boards profile (atmega328p, atmega328pb, atmega168pb).*/
Blockly.Arduino.Boards.reference.atmel_atmega328p_xplained_mini = {
  ...
  analogPins: Blockly.Arduino.Boards.reference.uno.analogPins,
  digitalPins: Blockly.Arduino.Boards.reference.uno.digitalPins.concat(
      [['20', '20']]),
  pwmPins: Blockly.Arduino.Boards.reference.uno.pwmPins,
  serial: Blockly.Arduino.Boards.reference.uno.serial,
  serialPins: Blockly.Arduino.Boards.reference.uno.serialPins,
...
Blockly.Arduino.Boards.reference.atmel_atmega328pb_xplained_mini = Blockly.Arduino.Boards.duplicateBoardProfile(
        Blockly.Arduino.Boards.reference.atmel_atmega328p_xplained_mini,
...
Blockly.Arduino.Boards.reference.atmel_atmega168pb_xplained_mini = Blockly.Arduino.Boards.duplicateBoardProfile(
        Blockly.Arduino.Boards.reference.atmel_atmega328p_xplained_mini,
...
Blockly.Arduino.Boards.reference.esp8266_huzzah = {
...
Blockly.Arduino.Boards.reference.esp8266_wemos_d1 = {
  name: 'Wemos D1',
